function [pdd, pddnode, meanpdd] = dyn_pdd_pleakage(data,sample,mindur,meanfreq)
% Computes the phase difference derivative (PDD) wit pairwise
...
fprintf('computed phase difference derivative (with pairwise leakage correction) \n')
end
